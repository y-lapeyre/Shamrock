...
def standalone(json_lst : list, figure_folder : str) -> str:
    ...
    buf = r"\section{Tree walk sph overhead}" + "\n\n"
    ...
    for report in json_lst:
        ...
        sort_perf = res.get_test_instances("Benchmark","shamrock_article1:sph_walk_perf")
        ...
        if len(sort_perf) == 1:
            ...
            for s in sort_perf:
                ...
                for dataset in s.test_data:
                    ...
                    plt.savefig(figure_folder+fileprefix+"walk_sph_overhead.pdf")
                    #plt.show()
                    ...
                    \begin{figure}[ht!]
                    \center
                    \includegraphics[width=0.9\textwidth]{"""+ "figures/"+fileprefix+"walk_sph_overhead.pdf" + r"""}
