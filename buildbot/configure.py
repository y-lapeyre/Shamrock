...
parser.add_argument(
    "--lib", action="store_true", help="build the lib instead of an executable (for python lib)"
)
...
parser.add_argument(
    "--interactive", action="store_true", help="additional cmake configuration flags"
)
...
profile_dpcpp = {
    ...
    "native_cpu": {
        "cxxflags": "-fsycl -fsycl-targets=native_cpu",
        "cmakeflags": intel_llvm_cmake_flag,
    },
    "cuda": {
    ...
    "cuda_sm86": {
        "cxxflags": "-fsycl -fsycl-targets=nvidia_gpu_sm_86",
        "cmakeflags": intel_llvm_cmake_flag,
    },
    "cuda_sm80": {
        "cxxflags": "-fsycl -fsycl-targets=nvidia_gpu_sm_80",
        "cmakeflags": intel_llvm_cmake_flag,
    },
    "cuda_sm75": {
        "cxxflags": "-fsycl -fsycl-targets=nvidia_gpu_sm_75",
        "cmakeflags": intel_llvm_cmake_flag,
    },
    "cuda_sm72": {
        "cxxflags": "-fsycl -fsycl-targets=nvidia_gpu_sm_72",
        "cmakeflags": intel_llvm_cmake_flag,
    },
    "cuda_sm70": {
        "cxxflags": "-fsycl -fsycl-targets=nvidia_gpu_sm_70",
        "cmakeflags": intel_llvm_cmake_flag,
    },
    "cuda_sm62": {
        "cxxflags": "-fsycl -fsycl-targets=nvidia_gpu_sm_62",
        "cmakeflags": intel_llvm_cmake_flag,
    },
    "cuda_sm61": {
        "cxxflags": "-fsycl -fsycl-targets=nvidia_gpu_sm_61",
        "cmakeflags": intel_llvm_cmake_flag,
    },
    "cuda_sm60": {
    ...
    "cuda_sm53": {
        "cxxflags": "-fsycl -fsycl-targets=nvidia_gpu_sm_53",
        "cmakeflags": intel_llvm_cmake_flag,
    },
    "hip-gfx906": {
        "cxxflags": "-fsycl -fsycl-targets=amdgcn-amd-amdhsa -Xsycl-target-backend --offload-arch=gfx906",
        "cmakeflags": intel_llvm_cmake_flag,
    },
...
profile_acpp = {
    "omp": {
        "cxxflags": "--hipsycl-cpu-cxx=g++ --hipsycl-targets='omp' " + hipsyclconfigfile,
        "cmakeflags": acpp_path_cmake_flag,
    },
    "omp_O3debug": {
        "cxxflags": "--hipsycl-cpu-cxx=g++ --hipsycl-targets='omp' -g " + hipsyclconfigfile,
        "cmakeflags": acpp_path_cmake_flag,
    },
    "omp_O3debugasan": {
        "cxxflags": "--hipsycl-cpu-cxx=g++ --hipsycl-targets='omp' -g -fsanitize=address "
        + hipsyclconfigfile,
        "cmakeflags": acpp_path_cmake_flag,
    },
    "omp_sanitizer": {
        "cxxflags": "-fsanitize=address --hipsycl-cpu-cxx=g++ --hipsycl-targets='omp' "
        + hipsyclconfigfile,
        "cmakeflags": acpp_path_cmake_flag,
    },
    "omp_coverage": {
        "cxxflags": "-fprofile-instr-generate -fcoverage-mapping --hipsycl-cpu-cxx=g++ --hipsycl-targets='omp' "
        + hipsyclconfigfile,
        "cmakeflags": acpp_path_cmake_flag,
    },
    "generic": {
        "cxxflags": "--hipsycl-targets=generic " + hipsyclconfigfile,
        "cmakeflags": acpp_path_cmake_flag,
    },
    "cuda-nvcxx": {
        "cxxflags": "--hipsycl-targets='cuda-nvcxx' " + hipsyclconfigfile,
        "cmakeflags": acpp_path_cmake_flag,
    },
    "cuda-sm70": {
        "cxxflags": "--hipsycl-targets='cuda:sm_70' " + hipsyclconfigfile,
        "cmakeflags": acpp_path_cmake_flag,
    },
    "hip-gfx906": {
        "cxxflags": "--hipsycl-targets='hip:gfx906' " + hipsyclconfigfile,
        "cmakeflags": acpp_path_cmake_flag,
    },
}
...
profile_acpp_cmake = {
    "omp": {
        "cxxflags": "",
        "cmakeflags": "-DUSE_ACPP_CMAKE=true -D"
        + acpp_cmake_name
        + "_TARGETS=omp "
        + cmake_dir_acpp_cmake,
    },
