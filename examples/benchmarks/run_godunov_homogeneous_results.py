"""
Godunov homogeneous benchmark results
======================================
...
json_file = os.path.join(base_path, "godunov_homogeneous_bench_result.json")
...
ax_rate.set_xlabel("rate (cells / s)")
ax_rate.set_xscale("log")
ax_rate.set_title("Godunov homogeneous - rate by device")
