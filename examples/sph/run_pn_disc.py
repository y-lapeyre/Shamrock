...
simulation of a circular disc orbiting around a central point mass pseudo-newtonian potential.
...
sim_folder = f"_to_trash/circular_disc_pn_pot_{Npart}/"
...
def setup_model():
    ...
    # Smoothing length iterations, increasing it affects the performance negatively but increases the
