...
file_data = "ghost_dump_debug1.00000011patch_0000.txt"
block_size = 8
...
ssize = 4
axs[0,0].scatter(select_cell_x,select_cell_rho, s = ssize, label = "initial")
axs[0,0].scatter(select_cell_x,select_cell_rho_end_transp, s = ssize, label = "end transp")
axs[0,0].set_title("rho")
axs[0,0].legend()


axs[0,1].scatter(select_cell_x,select_cell_Q[0], s = ssize, label = "Qrho")
axs[0,1].set_title("rho")
axs[0,1].legend()



axs[0,2].scatter(select_cell_x,select_cell_ax[0], s = ssize, label = "ax rho")
axs[0,2].set_title("axrho")
axs[0,2].legend()



axs[1,0].scatter(select_cell_x,select_cell_Qstar_x[0], s = ssize, label = "Qstar_x")
#axs[1,0].scatter(select_cell_x,select_cell_Qstar_y[0], s = ssize, label = "Qstar_y")
#axs[1,0].scatter(select_cell_x,select_cell_Qstar_z[0], s = ssize, label = "Qstar_z")
axs[1,0].scatter(select_cell_x,select_cell_Flux_x[0], s = ssize, label = "Flux_x")
#axs[1,0].scatter(select_cell_x,select_cell_Flux_y[0], s = ssize, label = "Flux_y")
#axs[1,0].scatter(select_cell_x,select_cell_Flux_z[0], s = ssize, label = "Flux_z")
axs[1,0].set_title("Qstar rho")
axs[1,0].legend()

axs[2,0].scatter(select_cell_x,select_cell_Flux_x[0], s = ssize, label = "Flux_x")
#axs[2,0].scatter(select_cell_x,select_cell_Flux_y[1], s = ssize, label = "Flux_y")
#axs[2,0].scatter(select_cell_x,select_cell_Flux_z[1], s = ssize, label = "Flux_z")
axs[2,0].set_title("flux x")
axs[2,0].legend()

axs[2,1].scatter(select_cell_x,select_cell_Q[4], s = ssize, label = "Q")
axs[2,1].scatter(select_cell_x,select_cell_ax[4], s = ssize, label = "ax")
axs[2,1].scatter(select_cell_x,select_cell_ay[4], s = ssize, label = "ay")
axs[2,1].scatter(select_cell_x,select_cell_az[4], s = ssize, label = "az")
axs[2,1].scatter(select_cell_x,select_cell_Qstar_x[4], s = ssize, label = "Qstar_x")
#axs[2,1].scatter(select_cell_x,select_cell_Qstar_y[4], s = ssize, label = "Qstar_y")
#axs[2,1].scatter(select_cell_x,select_cell_Qstar_z[4], s = ssize, label = "Qstar_z")
axs[2,1].scatter(select_cell_x,select_cell_Flux_x[4], s = ssize, label = "Flux_x")
#axs[2,1].scatter(select_cell_x,select_cell_Flux_y[4], s = ssize, label = "Flux_y")
#axs[2,1].scatter(select_cell_x,select_cell_Flux_z[4], s = ssize, label = "Flux_z")
axs[2,1].set_title("Q pi+x")
axs[2,1].legend()

axs[2,2].scatter(select_cell_x,select_cell_Q[7], s = ssize, label = "Q")
axs[2,2].scatter(select_cell_x,select_cell_ax[7], s = ssize, label = "ax")
axs[2,2].scatter(select_cell_x,select_cell_ay[7], s = ssize, label = "ay")
axs[2,2].scatter(select_cell_x,select_cell_az[7], s = ssize, label = "az")
axs[2,2].scatter(select_cell_x,select_cell_Qstar_x[7], s = ssize, label = "Qstar_x")
#axs[2,2].scatter(select_cell_x,select_cell_Qstar_y[7], s = ssize, label = "Qstar_y")
#axs[2,2].scatter(select_cell_x,select_cell_Qstar_z[7], s = ssize, label = "Qstar_z")
axs[2,2].scatter(select_cell_x,select_cell_Flux_x[7], s = ssize, label = "Flux_x")
#axs[2,2].scatter(select_cell_x,select_cell_Flux_y[7], s = ssize, label = "Flux_y")
#axs[2,2].scatter(select_cell_x,select_cell_Flux_z[7], s = ssize, label = "Flux_z")
axs[2,2].set_title("Q e")
axs[2,2].legend()



#axs[1,1].scatter(select_cell_x,select_cell_Q[0], s = ssize, label = "rho")
#axs[1,1].scatter(select_cell_x,select_cell_Q[1], s = ssize, label = "pi-x")
#axs[1,1].scatter(select_cell_x,select_cell_Q[2], s = ssize, label = "pi-y")
#axs[1,1].scatter(select_cell_x,select_cell_Q[3], s = ssize, label = "pi-z")
#axs[1,1].scatter(select_cell_x,select_cell_Q[4], s = ssize, label = "pi+x")
#axs[1,1].scatter(select_cell_x,select_cell_Q[5], s = ssize, label = "pi+y")
#axs[1,1].scatter(select_cell_x,select_cell_Q[6], s = ssize, label = "pi+z")
#axs[1,1].scatter(select_cell_x,select_cell_Q[7], s = ssize, label = "e")
