...
for k in dic.keys():
    plt.plot(
        ...
        / (np.array(dic[k]["rate"]) / np.array(dic[k]["X"]))[0],
        label=dic[k]["label"],
    )
# plt.ylim(0,1e6)
# plt.xlim(1,200)
...
dic["Adastra mi250X 1"] = {
    ...
    "cnt": [403064480, 802649952, 1606415328, 3211389720, 6421199616, 12828966752, 25658246736],
    "lb_pred": [100, 100, 100, 100, 100, 100, 100],
}
...
ax = fig.add_subplot(111)
idx = 0
pos_anot = [1.38e9, 5.0e9, 7e9, 10e9]
for k in dic.keys():
    X = dic[k]["X"]
