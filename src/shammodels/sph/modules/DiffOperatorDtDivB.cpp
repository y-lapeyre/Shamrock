...
void shammodels::sph::modules::DiffOperatorDtDivB<Tvec, SPHKernel>::update_dtdivB(
    ...
    logger::debug_ln("SPH", "Updating dt divB");
    ...
    scheduler().for_each_patchdata_nonempty([&](Patch cur_p, PatchData &pdat) {
        ...
        sycl::buffer<Tscal> &buf_dtdivB = pdat.get_field_buf_ref<Tscal>(idtdivB);
        ...
        if (!also_do_div_curl_B) {
            NamedStackEntry tmppp{"compute dtdivB"};
            shamsys::instance::get_compute_queue().submit([&](sycl::handler &cgh) {
                ...
                sycl::accessor dtdivB{buf_dtdivB, cgh, sycl::write_only, sycl::no_init};

                constexpr Tscal Rker2 = Kernel::Rkern * Kernel::Rkern;

                shambase::parralel_for(cgh, pdat.get_obj_cnt(), "compute dtdivB", [=](i32 id_a) {
                    ...
                    // divB[id_a] = div_vi;
                    // curlB[id_a] = curl_vi;
                    dtdivB[id_a] = div_ai - tens_nablav;
                });
            });
        } else {

            NamedStackEntry tmppp{"compute dtdivB +divcurl v"};
            ...
            shamsys::instance::get_compute_queue().submit([&](sycl::handler &cgh) {
                ...
                shambase::parralel_for(
                    cgh, pdat.get_obj_cnt(), "compute dtdivB + divcurl v", [=](i32 id_a) {
                        using namespace shamrock::sph;
                        ...
                        // divB[id_a] = div_vi;
                        // curlB[id_a] = curl_vi;
                        divB[id_a]   = -inv_rho_omega_a * sum_nabla_v;
                        curlB[id_a]  = -inv_rho_omega_a * sum_nabla_cross_v;
                        dtdivB[id_a] = div_ai - tens_nablav;
                    });
            });
        }
