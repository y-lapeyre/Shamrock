...
void shammodels::sph::modules::UpdateDerivs<Tvec, SPHKernel>::update_derivs() {
        ...
        scheduler().for_each_patchdata_nonempty([&](Patch cur_p, PatchData &pdat) {
            ...
            shamsys::instance::get_compute_queue().submit([&](sycl::handler &cgh) {
                ...
                shambase::parralel_for(
                    cgh, pdat.get_obj_cnt(), "compute force cte AV", [=](u64 gid) {
                        u32 id_a = (u32) gid;
    ...
    template<class Tvec, template<class> class SPHKernel>
    void shammodels::sph::modules::UpdateDerivs<Tvec, SPHKernel>::update_derivs_mm97(
        VaryingMM97 cfg) {
        StackEntry stack_loc{};
        ...
        scheduler().for_each_patchdata_nonempty([&](Patch cur_p, PatchData &pdat) {
            ...
            sycl::buffer<Tscal> &buf_pressure
                = storage.pressure.get().get_buf_check(cur_p.id_patch);
            sycl::buffer<Tscal> &buf_alpha_AV = shambase::get_check_ref(
            ...
            shamsys::instance::get_compute_queue().submit([&](sycl::handler &cgh) {
                ...
                shambase::parralel_for(
                    cgh, pdat.get_obj_cnt(), "compute force MM97 AV", [=](u64 gid) {
                        u32 id_a = (u32) gid;
    ...
    template<class Tvec, template<class> class SPHKernel>
    void shammodels::sph::modules::UpdateDerivs<Tvec, SPHKernel>::update_derivs_cd10(
        VaryingCD10 cfg) {
        StackEntry stack_loc{};
        ...
        scheduler().for_each_patchdata_nonempty([&](Patch cur_p, PatchData &pdat) {
            ...
            shamsys::instance::get_compute_queue().submit([&](sycl::handler &cgh) {
                ...
                shambase::parralel_for(
                    cgh, pdat.get_obj_cnt(), "compute force CD10 AV", [=](u64 gid) {
                        u32 id_a = (u32) gid;
