...
void add_instance(py::module &m, std::string name_config, std::string name_model) {
    ...
    config_cls.def("print_status", &TConfig::print_status)
        ...
        .def(
            "set_IdealMHD",
            [](TConfig &self, Tscal sigma_mhd, Tscal sigma_u, Tscal alpha_B) {
                self.set_IdealMHD({sigma_mhd, sigma_u, alpha_B});
            },
            py::kw_only(),
            py::arg("sigma_mhd"),
            py::arg("sigma_u"),
        ...
        .def(
            ...
            [](TConfig &self,
               ...
               Tscal etaAD,
               Tscal alpha_B) {
                self.set_NonIdealMHD({sigma_mhd, sigma_u, alpha_B, etaO, etaH, etaAD});
            },
            py::kw_only(),
            py::arg("sigma_mhd"),
            py::arg("sigma_u"),
