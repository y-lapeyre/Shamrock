...
template  shammodels::EOSConfig<f32_3> shammodels::sph::get_shamrock_eosconfig<f32_3>(PhantomDump &phdump);
template  shammodels::EOSConfig<f64_3> shammodels::sph::get_shamrock_eosconfig<f64_3>(PhantomDump &phdump);