...
struct shammodels::sph::SolverConfig {
    ...
    /// Set the force time step for the next iteration
    inline void set_next_force_dt(Tscal dt) { time_state.dt_force = dt; }
    ...
    /// Get the time step relative to external forces: usuful for substepping
