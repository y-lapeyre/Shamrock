...
namespace mpi {
    ...
    inline int accumulate(const void *origin_addr, int origin_count, MPI_Datatype origin_datatype, int target_rank, MPI_Aint target_disp, int target_count, MPI_Datatype target_datatype, MPI_Op op, MPI_Win win){
        CALL_LOG_RETURN(MPI_Accumulate,(origin_addr,origin_count,origin_datatype,target_rank,target_disp,target_count,target_datatype,op,win));
    }
    ...
    inline int allgather(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, int recvcount, MPI_Datatype recvtype, MPI_Comm comm){
        CALL_LOG_RETURN(MPI_Allgather,(sendbuf,sendcount,sendtype,recvbuf,recvcount,recvtype,comm));
    }
    inline int iallgather(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, int recvcount, MPI_Datatype recvtype, MPI_Comm comm, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Iallgather,(sendbuf,sendcount,sendtype,recvbuf,recvcount,recvtype,comm,request));
    }
    inline int allgatherv(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, const int recvcounts[], const int displs[], MPI_Datatype recvtype, MPI_Comm comm){
        CALL_LOG_RETURN(MPI_Allgatherv,(sendbuf,sendcount,sendtype,recvbuf,recvcounts,displs,recvtype,comm));
    }
    inline int iallgatherv(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, const int recvcounts[], const int displs[], MPI_Datatype recvtype, MPI_Comm comm, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Iallgatherv,(sendbuf,sendcount,sendtype,recvbuf,recvcounts,displs,recvtype,comm,request));
    }
    inline int alloc_mem(MPI_Aint size, MPI_Info info, void *baseptr){
        CALL_LOG_RETURN(MPI_Alloc_mem,(size,info,baseptr));
    }
    inline int allreduce(const void *sendbuf, void *recvbuf, int count, MPI_Datatype datatype, MPI_Op op, MPI_Comm comm){
    ...
    inline int alltoall(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, int recvcount, MPI_Datatype recvtype, MPI_Comm comm){
        CALL_LOG_RETURN(MPI_Alltoall,(sendbuf,sendcount,sendtype,recvbuf,recvcount,recvtype,comm));
    }
    inline int ialltoall(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, int recvcount, MPI_Datatype recvtype, MPI_Comm comm, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Ialltoall,(sendbuf,sendcount,sendtype,recvbuf,recvcount,recvtype,comm,request));
    }
    inline int alltoallv(const void *sendbuf, const int sendcounts[], const int sdispls[], MPI_Datatype sendtype, void *recvbuf, const int recvcounts[], const int rdispls[], MPI_Datatype recvtype, MPI_Comm comm){
        CALL_LOG_RETURN(MPI_Alltoallv,(sendbuf,sendcounts,sdispls,sendtype,recvbuf,recvcounts,rdispls,recvtype,comm));
    }
    inline int ialltoallv(const void *sendbuf, const int sendcounts[], const int sdispls[], MPI_Datatype sendtype, void *recvbuf, const int recvcounts[], const int rdispls[], MPI_Datatype recvtype, MPI_Comm comm, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Ialltoallv,(sendbuf,sendcounts,sdispls,sendtype,recvbuf,recvcounts,rdispls,recvtype,comm,request));
    }
    inline int alltoallw(const void *sendbuf, const int sendcounts[], const int sdispls[], const MPI_Datatype sendtypes[], void *recvbuf, const int recvcounts[], const int rdispls[], const MPI_Datatype recvtypes[], MPI_Comm comm){
        CALL_LOG_RETURN(MPI_Alltoallw,(sendbuf,sendcounts,sdispls,sendtypes,recvbuf,recvcounts,rdispls,recvtypes,comm));
    }
    inline int ialltoallw(const void *sendbuf, const int sendcounts[], const int sdispls[], const MPI_Datatype sendtypes[], void *recvbuf, const int recvcounts[], const int rdispls[], const MPI_Datatype recvtypes[], MPI_Comm comm, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Ialltoallw,(sendbuf,sendcounts,sdispls,sendtypes,recvbuf,recvcounts,rdispls,recvtypes,comm,request));
    }
    inline int barrier(MPI_Comm comm){
        CALL_LOG_RETURN(MPI_Barrier,(comm));
    }
    ...
    inline int bsend(const void *buf, int count, MPI_Datatype datatype, int dest, int tag, MPI_Comm comm){
    ...
    inline int bsend_init(const void *buf, int count, MPI_Datatype datatype, int dest, int tag, MPI_Comm comm, MPI_Request *request){
    ...
    inline int cancel(MPI_Request *request){
        CALL_LOG_RETURN(MPI_Cancel,(request));
    }
    ...
    inline int cart_create(MPI_Comm old_comm, int ndims, const int dims[], const int periods[], int reorder, MPI_Comm *comm_cart){
    ...
    inline int cart_map(MPI_Comm comm, int ndims, const int dims[], const int periods[], int *newrank){
    ...
    inline int close_port(const char *port_name){
        CALL_LOG_RETURN(MPI_Close_port,(port_name));
    }
    inline int comm_accept(const char *port_name, MPI_Info info, int root, MPI_Comm comm, MPI_Comm *newcomm){
        CALL_LOG_RETURN(MPI_Comm_accept,(port_name,info,root,comm,newcomm));
    }
    inline MPI_Fint comm_c2f(MPI_Comm comm){
        CALL_LOG_RETURN(MPI_Comm_c2f,(comm));
    }
    ...
    inline int comm_connect(const char *port_name, MPI_Info info, int root, MPI_Comm comm, MPI_Comm *newcomm){
        CALL_LOG_RETURN(MPI_Comm_connect,(port_name,info,root,comm,newcomm));
    }
    inline int comm_create_errhandler(MPI_Comm_errhandler_function *function, MPI_Errhandler *errhandler){
    ...
    inline int comm_create_keyval(MPI_Comm_copy_attr_function *comm_copy_attr_fn, MPI_Comm_delete_attr_function *comm_delete_attr_fn, int *comm_keyval, void *extra_state){
        CALL_LOG_RETURN(MPI_Comm_create_keyval,(comm_copy_attr_fn,comm_delete_attr_fn,comm_keyval,extra_state));
    }
    ...
    inline int comm_disconnect(MPI_Comm *comm){
        CALL_LOG_RETURN(MPI_Comm_disconnect,(comm));
    }
    ...
    inline MPI_Comm comm_f2c(MPI_Fint comm){
        CALL_LOG_RETURN(MPI_Comm_f2c,(comm));
    }
    ...
    inline int comm_free(MPI_Comm *comm){
        CALL_LOG_RETURN(MPI_Comm_free,(comm));
    }
    ...
    inline int dist_graph_create(MPI_Comm comm_old, int n, const int nodes[], const int degrees[], const int targets[], const int weights[], MPI_Info info, int reorder, MPI_Comm * newcomm){
        CALL_LOG_RETURN(MPI_Dist_graph_create,(comm_old,n,nodes,degrees,targets,weights,info,reorder,newcomm));
    }
    inline int dist_graph_create_adjacent(MPI_Comm comm_old, int indegree, const int sources[], const int sourceweights[], int outdegree, const int destinations[], const int destweights[], MPI_Info info, int reorder, MPI_Comm *comm_dist_graph){
        CALL_LOG_RETURN(MPI_Dist_graph_create_adjacent,(comm_old,indegree,sources,sourceweights,outdegree,destinations,destweights,info,reorder,comm_dist_graph));
    }
    inline int dist_graph_neighbors(MPI_Comm comm, int maxindegree, int sources[], int sourceweights[], int maxoutdegree, int destinations[], int destweights[]){
        CALL_LOG_RETURN(MPI_Dist_graph_neighbors,(comm,maxindegree,sources,sourceweights,maxoutdegree,destinations,destweights));
    }
    inline int dist_graph_neighbors_count(MPI_Comm comm, int *inneighbors, int *outneighbors, int *weighted){
        CALL_LOG_RETURN(MPI_Dist_graph_neighbors_count,(comm,inneighbors,outneighbors,weighted));
    }
    ...
    inline int comm_get_parent(MPI_Comm *parent){
        CALL_LOG_RETURN(MPI_Comm_get_parent,(parent));
    }
    ...
    inline int comm_rank(MPI_Comm comm, int *rank){
        CALL_LOG_RETURN(MPI_Comm_rank,(comm,rank));
    }
    ...
    inline int comm_size(MPI_Comm comm, int *size){
        CALL_LOG_RETURN(MPI_Comm_size,(comm,size));
    }
    inline int comm_spawn(const char *command, char *argv[], int maxprocs, MPI_Info info, int root, MPI_Comm comm, MPI_Comm *intercomm, int array_of_errcodes[]){
        CALL_LOG_RETURN(MPI_Comm_spawn,(command,argv,maxprocs,info,root,comm,intercomm,array_of_errcodes));
    }
    inline int comm_spawn_multiple(int count, char *array_of_commands[], char **array_of_argv[], const int array_of_maxprocs[], const MPI_Info array_of_info[], int root, MPI_Comm comm, MPI_Comm *intercomm, int array_of_errcodes[]){
        CALL_LOG_RETURN(MPI_Comm_spawn_multiple,(count,array_of_commands,array_of_argv,array_of_maxprocs,array_of_info,root,comm,intercomm,array_of_errcodes));
    }
    ...
    inline int compare_and_swap(const void *origin_addr, const void *compare_addr, void *result_addr, MPI_Datatype datatype, int target_rank, MPI_Aint target_disp, MPI_Win win){
        CALL_LOG_RETURN(MPI_Compare_and_swap,(origin_addr,compare_addr,result_addr,datatype,target_rank,target_disp,win));
    }
    ...
    inline int exscan(const void *sendbuf, void *recvbuf, int count, MPI_Datatype datatype, MPI_Op op, MPI_Comm comm){
    ...
    inline int fetch_and_op(const void *origin_addr, void *result_addr, MPI_Datatype datatype, int target_rank, MPI_Aint target_disp, MPI_Op op, MPI_Win win){
        CALL_LOG_RETURN(MPI_Fetch_and_op,(origin_addr,result_addr,datatype,target_rank,target_disp,op,win));
    }
    ...
    inline MPI_Fint file_c2f(MPI_File file){
        CALL_LOG_RETURN(MPI_File_c2f,(file));
    }
    inline MPI_File file_f2c(MPI_Fint file){
        CALL_LOG_RETURN(MPI_File_f2c,(file));
    }
    inline int file_call_errhandler(MPI_File fh, int errorcode){
        CALL_LOG_RETURN(MPI_File_call_errhandler,(fh,errorcode));
    }
    inline int file_create_errhandler(MPI_File_errhandler_function *function, MPI_Errhandler *errhandler){
    ...
    inline int file_open(MPI_Comm comm, const char *filename, int amode, MPI_Info info, MPI_File *fh){
        CALL_LOG_RETURN(MPI_File_open,(comm,filename,amode,info,fh));
    }
    inline int file_close(MPI_File *fh){
        CALL_LOG_RETURN(MPI_File_close,(fh));
    }
    ...
    inline int file_set_view(MPI_File fh, MPI_Offset disp, MPI_Datatype etype, MPI_Datatype filetype, const char *datarep, MPI_Info info){
        CALL_LOG_RETURN(MPI_File_set_view,(fh,disp,etype,filetype,datarep,info));
    }
    inline int file_get_view(MPI_File fh, MPI_Offset *disp, MPI_Datatype *etype, MPI_Datatype *filetype, char *datarep){
        CALL_LOG_RETURN(MPI_File_get_view,(fh,disp,etype,filetype,datarep));
    }
    inline int file_read_at(MPI_File fh, MPI_Offset offset, void *buf, int count, MPI_Datatype datatype, MPI_Status *status){
        CALL_LOG_RETURN(MPI_File_read_at,(fh,offset,buf,count,datatype,status));
    }
    inline int file_read_at_all(MPI_File fh, MPI_Offset offset, void *buf, int count, MPI_Datatype datatype, MPI_Status *status){
        CALL_LOG_RETURN(MPI_File_read_at_all,(fh,offset,buf,count,datatype,status));
    }
    inline int file_write_at(MPI_File fh, MPI_Offset offset, const void *buf, int count, MPI_Datatype datatype, MPI_Status *status){
        CALL_LOG_RETURN(MPI_File_write_at,(fh,offset,buf,count,datatype,status));
    }
    inline int file_write_at_all(MPI_File fh, MPI_Offset offset, const void *buf, int count, MPI_Datatype datatype, MPI_Status *status){
        CALL_LOG_RETURN(MPI_File_write_at_all,(fh,offset,buf,count,datatype,status));
    }
    inline int file_iread_at(MPI_File fh, MPI_Offset offset, void *buf, int count, MPI_Datatype datatype, MPI_Request *request){
        CALL_LOG_RETURN(MPI_File_iread_at,(fh,offset,buf,count,datatype,request));
    }
    inline int file_iwrite_at(MPI_File fh, MPI_Offset offset, const void *buf, int count, MPI_Datatype datatype, MPI_Request *request){
        CALL_LOG_RETURN(MPI_File_iwrite_at,(fh,offset,buf,count,datatype,request));
    }
    inline int file_iread_at_all(MPI_File fh, MPI_Offset offset, void *buf, int count, MPI_Datatype datatype, MPI_Request *request){
        CALL_LOG_RETURN(MPI_File_iread_at_all,(fh,offset,buf,count,datatype,request));
    }
    inline int file_iwrite_at_all(MPI_File fh, MPI_Offset offset, const void *buf, int count, MPI_Datatype datatype, MPI_Request *request){
        CALL_LOG_RETURN(MPI_File_iwrite_at_all,(fh,offset,buf,count,datatype,request));
    }
    inline int file_read(MPI_File fh, void *buf, int count, MPI_Datatype datatype, MPI_Status *status){
        CALL_LOG_RETURN(MPI_File_read,(fh,buf,count,datatype,status));
    }
    inline int file_read_all(MPI_File fh, void *buf, int count, MPI_Datatype datatype, MPI_Status *status){
        CALL_LOG_RETURN(MPI_File_read_all,(fh,buf,count,datatype,status));
    }
    inline int file_write(MPI_File fh, const void *buf, int count, MPI_Datatype datatype, MPI_Status *status){
        CALL_LOG_RETURN(MPI_File_write,(fh,buf,count,datatype,status));
    }
    inline int file_write_all(MPI_File fh, const void *buf, int count, MPI_Datatype datatype, MPI_Status *status){
        CALL_LOG_RETURN(MPI_File_write_all,(fh,buf,count,datatype,status));
    }
    inline int file_iread(MPI_File fh, void *buf, int count, MPI_Datatype datatype, MPI_Request *request){
        CALL_LOG_RETURN(MPI_File_iread,(fh,buf,count,datatype,request));
    }
    inline int file_iwrite(MPI_File fh, const void *buf, int count, MPI_Datatype datatype, MPI_Request *request){
        CALL_LOG_RETURN(MPI_File_iwrite,(fh,buf,count,datatype,request));
    }
    inline int file_iread_all(MPI_File fh, void *buf, int count, MPI_Datatype datatype, MPI_Request *request){
        CALL_LOG_RETURN(MPI_File_iread_all,(fh,buf,count,datatype,request));
    }
    inline int file_iwrite_all(MPI_File fh, const void *buf, int count, MPI_Datatype datatype, MPI_Request *request){
    ...
    inline int file_read_shared(MPI_File fh, void *buf, int count, MPI_Datatype datatype, MPI_Status *status){
        CALL_LOG_RETURN(MPI_File_read_shared,(fh,buf,count,datatype,status));
    }
    inline int file_write_shared(MPI_File fh, const void *buf, int count,					 MPI_Datatype datatype, MPI_Status *status){
        CALL_LOG_RETURN(MPI_File_write_shared,(fh,buf,count,datatype,status));
    }
    inline int file_iread_shared(MPI_File fh, void *buf, int count, MPI_Datatype datatype, MPI_Request *request){
        CALL_LOG_RETURN(MPI_File_iread_shared,(fh,buf,count,datatype,request));
    }
    inline int file_iwrite_shared(MPI_File fh, const void *buf, int count, MPI_Datatype datatype, MPI_Request *request){
        CALL_LOG_RETURN(MPI_File_iwrite_shared,(fh,buf,count,datatype,request));
    }
    inline int file_read_ordered(MPI_File fh, void *buf, int count, MPI_Datatype datatype, MPI_Status *status){
        CALL_LOG_RETURN(MPI_File_read_ordered,(fh,buf,count,datatype,status));
    }
    inline int file_write_ordered(MPI_File fh, const void *buf, int count, MPI_Datatype datatype, MPI_Status *status){
    ...
    inline int file_read_at_all_begin(MPI_File fh, MPI_Offset offset, void *buf, int count, MPI_Datatype datatype){
    ...
    inline int file_write_at_all_begin(MPI_File fh, MPI_Offset offset, const void *buf, int count, MPI_Datatype datatype){
    ...
    inline int file_write_all_begin(MPI_File fh, const void *buf, int count, MPI_Datatype datatype){
    ...
    inline int file_write_ordered_begin(MPI_File fh, const void *buf, int count, MPI_Datatype datatype){
    ...
    inline int file_sync(MPI_File fh){
        CALL_LOG_RETURN(MPI_File_sync,(fh));
    }
    inline int finalize(void){
        CALL_LOG_RETURN(MPI_Finalize,());
    }
    inline int finalized(int *flag){
        CALL_LOG_RETURN(MPI_Finalized,(flag));
    }
    inline int free_mem(void *base){
        CALL_LOG_RETURN(MPI_Free_mem,(base));
    }
    inline int gather(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, int recvcount, MPI_Datatype recvtype, int root, MPI_Comm comm){
        CALL_LOG_RETURN(MPI_Gather,(sendbuf,sendcount,sendtype,recvbuf,recvcount,recvtype,root,comm));
    }
    inline int igather(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, int recvcount, MPI_Datatype recvtype, int root, MPI_Comm comm, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Igather,(sendbuf,sendcount,sendtype,recvbuf,recvcount,recvtype,root,comm,request));
    }
    inline int gatherv(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, const int recvcounts[], const int displs[], MPI_Datatype recvtype, int root, MPI_Comm comm){
        CALL_LOG_RETURN(MPI_Gatherv,(sendbuf,sendcount,sendtype,recvbuf,recvcounts,displs,recvtype,root,comm));
    }
    inline int igatherv(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, const int recvcounts[], const int displs[], MPI_Datatype recvtype, int root, MPI_Comm comm, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Igatherv,(sendbuf,sendcount,sendtype,recvbuf,recvcounts,displs,recvtype,root,comm,request));
    }
    ...
    inline int get(void *origin_addr, int origin_count, MPI_Datatype origin_datatype, int target_rank, MPI_Aint target_disp, int target_count, MPI_Datatype target_datatype, MPI_Win win){
        CALL_LOG_RETURN(MPI_Get,(origin_addr,origin_count,origin_datatype,target_rank,target_disp,target_count,target_datatype,win));
    }
    inline int get_accumulate(const void *origin_addr, int origin_count, MPI_Datatype origin_datatype, void *result_addr, int result_count, MPI_Datatype result_datatype, int target_rank, MPI_Aint target_disp, int target_count, MPI_Datatype target_datatype, MPI_Op op, MPI_Win win){
        CALL_LOG_RETURN(MPI_Get_accumulate,(origin_addr,origin_count,origin_datatype,result_addr,result_count,result_datatype,target_rank,target_disp,target_count,target_datatype,op,win));
    }
    ...
    inline int graph_create(MPI_Comm comm_old, int nnodes, const int index[], const int edges[], int reorder, MPI_Comm *comm_graph){
    ...
    inline int graph_map(MPI_Comm comm, int nnodes, const int index[], const int edges[], int *newrank){
    ...
    inline MPI_Fint group_c2f(MPI_Group group){
        CALL_LOG_RETURN(MPI_Group_c2f,(group));
    }
    ...
    inline MPI_Group group_f2c(MPI_Fint group){
        CALL_LOG_RETURN(MPI_Group_f2c,(group));
    }
    inline int group_free(MPI_Group *group){
        CALL_LOG_RETURN(MPI_Group_free,(group));
    }
    ...
    inline int group_translate_ranks(MPI_Group group1, int n, const int ranks1[], MPI_Group group2, int ranks2[]){
    ...
    inline int ibsend(const void *buf, int count, MPI_Datatype datatype, int dest, int tag, MPI_Comm comm, MPI_Request *request){
    ...
    inline int imrecv(void *buf, int count, MPI_Datatype type, MPI_Message *message, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Imrecv,(buf,count,type,message,request));
    }
    inline MPI_Fint info_c2f(MPI_Info info){
        CALL_LOG_RETURN(MPI_Info_c2f,(info));
    }
    inline int info_create(MPI_Info *info){
        CALL_LOG_RETURN(MPI_Info_create,(info));
    }
    ...
    inline MPI_Info info_f2c(MPI_Fint info){
        CALL_LOG_RETURN(MPI_Info_f2c,(info));
    }
    inline int info_free(MPI_Info *info){
        CALL_LOG_RETURN(MPI_Info_free,(info));
    }
    ...
    inline int init(int *argc, char ***argv){
        CALL_LOG_RETURN(MPI_Init,(argc,argv));
    }
    inline int initialized(int *flag){
        CALL_LOG_RETURN(MPI_Initialized,(flag));
    }
    ...
    inline int intercomm_create(MPI_Comm local_comm, int local_leader, MPI_Comm bridge_comm, int remote_leader, int tag, MPI_Comm *newintercomm){
        CALL_LOG_RETURN(MPI_Intercomm_create,(local_comm,local_leader,bridge_comm,remote_leader,tag,newintercomm));
    }
    ...
    inline int irsend(const void *buf, int count, MPI_Datatype datatype, int dest, int tag, MPI_Comm comm, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Irsend,(buf,count,datatype,dest,tag,comm,request));
    }
    inline int isend(const void *buf, int count, MPI_Datatype datatype, int dest, int tag, MPI_Comm comm, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Isend,(buf,count,datatype,dest,tag,comm,request));
    }
    inline int issend(const void *buf, int count, MPI_Datatype datatype, int dest, int tag, MPI_Comm comm, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Issend,(buf,count,datatype,dest,tag,comm,request));
    }
    inline int is_thread_main(int *flag){
        CALL_LOG_RETURN(MPI_Is_thread_main,(flag));
    }
    ...
    inline int mrecv(void *buf, int count, MPI_Datatype type, MPI_Message *message, MPI_Status *status){
        CALL_LOG_RETURN(MPI_Mrecv,(buf,count,type,message,status));
    }
    inline int neighbor_allgather(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, int recvcount, MPI_Datatype recvtype, MPI_Comm comm){
        CALL_LOG_RETURN(MPI_Neighbor_allgather,(sendbuf,sendcount,sendtype,recvbuf,recvcount,recvtype,comm));
    }
    inline int ineighbor_allgather(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, int recvcount, MPI_Datatype recvtype, MPI_Comm comm, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Ineighbor_allgather,(sendbuf,sendcount,sendtype,recvbuf,recvcount,recvtype,comm,request));
    }
    inline int neighbor_allgatherv(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, const int recvcounts[], const int displs[], MPI_Datatype recvtype, MPI_Comm comm){
        CALL_LOG_RETURN(MPI_Neighbor_allgatherv,(sendbuf,sendcount,sendtype,recvbuf,recvcounts,displs,recvtype,comm));
    }
    inline int ineighbor_allgatherv(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, const int recvcounts[], const int displs[], MPI_Datatype recvtype, MPI_Comm comm, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Ineighbor_allgatherv,(sendbuf,sendcount,sendtype,recvbuf,recvcounts,displs,recvtype,comm,request));
    }
    inline int neighbor_alltoall(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, int recvcount, MPI_Datatype recvtype, MPI_Comm comm){
        CALL_LOG_RETURN(MPI_Neighbor_alltoall,(sendbuf,sendcount,sendtype,recvbuf,recvcount,recvtype,comm));
    }
    inline int ineighbor_alltoall(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, int recvcount, MPI_Datatype recvtype, MPI_Comm comm, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Ineighbor_alltoall,(sendbuf,sendcount,sendtype,recvbuf,recvcount,recvtype,comm,request));
    }
    inline int neighbor_alltoallv(const void *sendbuf, const int sendcounts[], const int sdispls[], MPI_Datatype sendtype, void *recvbuf, const int recvcounts[], const int rdispls[], MPI_Datatype recvtype, MPI_Comm comm){
        CALL_LOG_RETURN(MPI_Neighbor_alltoallv,(sendbuf,sendcounts,sdispls,sendtype,recvbuf,recvcounts,rdispls,recvtype,comm));
    }
    inline int ineighbor_alltoallv(const void *sendbuf, const int sendcounts[], const int sdispls[], MPI_Datatype sendtype, void *recvbuf, const int recvcounts[], const int rdispls[], MPI_Datatype recvtype, MPI_Comm comm, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Ineighbor_alltoallv,(sendbuf,sendcounts,sdispls,sendtype,recvbuf,recvcounts,rdispls,recvtype,comm,request));
    }
    inline int neighbor_alltoallw(const void *sendbuf, const int sendcounts[], const MPI_Aint sdispls[], const MPI_Datatype sendtypes[], void *recvbuf, const int recvcounts[], const MPI_Aint rdispls[], const MPI_Datatype recvtypes[], MPI_Comm comm){
        CALL_LOG_RETURN(MPI_Neighbor_alltoallw,(sendbuf,sendcounts,sdispls,sendtypes,recvbuf,recvcounts,rdispls,recvtypes,comm));
    }
    inline int ineighbor_alltoallw(const void *sendbuf, const int sendcounts[], const MPI_Aint sdispls[], const MPI_Datatype sendtypes[], void *recvbuf, const int recvcounts[], const MPI_Aint rdispls[], const MPI_Datatype recvtypes[], MPI_Comm comm, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Ineighbor_alltoallw,(sendbuf,sendcounts,sdispls,sendtypes,recvbuf,recvcounts,rdispls,recvtypes,comm,request));
    }
    inline MPI_Fint op_c2f(MPI_Op op){
        CALL_LOG_RETURN(MPI_Op_c2f,(op));
    }
    ...
    inline MPI_Op op_f2c(MPI_Fint op){
        CALL_LOG_RETURN(MPI_Op_f2c,(op));
    }
    inline int op_free(MPI_Op *op){
        CALL_LOG_RETURN(MPI_Op_free,(op));
    }
    inline int pack_external(const char datarep[], const void *inbuf, int incount, MPI_Datatype datatype, void *outbuf, MPI_Aint outsize, MPI_Aint *position){
        CALL_LOG_RETURN(MPI_Pack_external,(datarep,inbuf,incount,datatype,outbuf,outsize,position));
    }
    inline int pack_external_size(const char datarep[], int incount, MPI_Datatype datatype, MPI_Aint *size){
        CALL_LOG_RETURN(MPI_Pack_external_size,(datarep,incount,datatype,size));
    }
    inline int pack(const void *inbuf, int incount, MPI_Datatype datatype, void *outbuf, int outsize, int *position, MPI_Comm comm){
    ...
    inline int put(const void *origin_addr, int origin_count, MPI_Datatype origin_datatype, int target_rank, MPI_Aint target_disp, int target_count, MPI_Datatype target_datatype, MPI_Win win){
        CALL_LOG_RETURN(MPI_Put,(origin_addr,origin_count,origin_datatype,target_rank,target_disp,target_count,target_datatype,win));
    }
    inline int query_thread(int *provided){
        CALL_LOG_RETURN(MPI_Query_thread,(provided));
    }
    inline int raccumulate(const void *origin_addr, int origin_count, MPI_Datatype origin_datatype, int target_rank, MPI_Aint target_disp, int target_count, MPI_Datatype target_datatype, MPI_Op op, MPI_Win win, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Raccumulate,(origin_addr,origin_count,origin_datatype,target_rank,target_disp,target_count,target_datatype,op,win,request));
    }
    ...
    inline int reduce(const void *sendbuf, void *recvbuf, int count, MPI_Datatype datatype, MPI_Op op, int root, MPI_Comm comm){
    ...
    inline int reduce_local(const void *inbuf, void *inoutbuf, int count, MPI_Datatype datatype, MPI_Op op){
        CALL_LOG_RETURN(MPI_Reduce_local,(inbuf,inoutbuf,count,datatype,op));
    }
    inline int reduce_scatter(const void *sendbuf, void *recvbuf, const int recvcounts[], MPI_Datatype datatype, MPI_Op op, MPI_Comm comm){
        CALL_LOG_RETURN(MPI_Reduce_scatter,(sendbuf,recvbuf,recvcounts,datatype,op,comm));
    }
    inline int ireduce_scatter(const void *sendbuf, void *recvbuf, const int recvcounts[], MPI_Datatype datatype, MPI_Op op, MPI_Comm comm, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Ireduce_scatter,(sendbuf,recvbuf,recvcounts,datatype,op,comm,request));
    }
    inline int reduce_scatter_block(const void *sendbuf, void *recvbuf, int recvcount, MPI_Datatype datatype, MPI_Op op, MPI_Comm comm){
        CALL_LOG_RETURN(MPI_Reduce_scatter_block,(sendbuf,recvbuf,recvcount,datatype,op,comm));
    }
    inline int ireduce_scatter_block(const void *sendbuf, void *recvbuf, int recvcount, MPI_Datatype datatype, MPI_Op op, MPI_Comm comm, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Ireduce_scatter_block,(sendbuf,recvbuf,recvcount,datatype,op,comm,request));
    }
    inline int register_datarep(const char *datarep, MPI_Datarep_conversion_function *read_conversion_fn, MPI_Datarep_conversion_function *write_conversion_fn, MPI_Datarep_extent_function *dtype_file_extent_fn, void *extra_state){
        CALL_LOG_RETURN(MPI_Register_datarep,(datarep,read_conversion_fn,write_conversion_fn,dtype_file_extent_fn,extra_state));
    }
    ...
    inline int request_free(MPI_Request *request){
        CALL_LOG_RETURN(MPI_Request_free,(request));
    }
    ...
    inline int rget(void *origin_addr, int origin_count, MPI_Datatype origin_datatype, int target_rank, MPI_Aint target_disp, int target_count, MPI_Datatype target_datatype, MPI_Win win, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Rget,(origin_addr,origin_count,origin_datatype,target_rank,target_disp,target_count,target_datatype,win,request));
    }
    inline int rget_accumulate(const void *origin_addr, int origin_count, MPI_Datatype origin_datatype, void *result_addr, int result_count, MPI_Datatype result_datatype, int target_rank, MPI_Aint target_disp, int target_count, MPI_Datatype target_datatype, MPI_Op op, MPI_Win win, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Rget_accumulate,(origin_addr,origin_count,origin_datatype,result_addr,result_count,result_datatype,target_rank,target_disp,target_count,target_datatype,op,win,request));
    }
    inline int rput(const void *origin_addr, int origin_count, MPI_Datatype origin_datatype, int target_rank, MPI_Aint target_disp, int target_cout, MPI_Datatype target_datatype, MPI_Win win, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Rput,(origin_addr,origin_count,origin_datatype,target_rank,target_disp,target_cout,target_datatype,win,request));
    }
    inline int rsend(const void *ibuf, int count, MPI_Datatype datatype, int dest, int tag, MPI_Comm comm){
        CALL_LOG_RETURN(MPI_Rsend,(ibuf,count,datatype,dest,tag,comm));
    }
    inline int rsend_init(const void *buf, int count, MPI_Datatype datatype, int dest, int tag, MPI_Comm comm, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Rsend_init,(buf,count,datatype,dest,tag,comm,request));
    }
    inline int scan(const void *sendbuf, void *recvbuf, int count, MPI_Datatype datatype, MPI_Op op, MPI_Comm comm){
    ...
    inline int scatter(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, int recvcount, MPI_Datatype recvtype, int root, MPI_Comm comm){
        CALL_LOG_RETURN(MPI_Scatter,(sendbuf,sendcount,sendtype,recvbuf,recvcount,recvtype,root,comm));
    }
    inline int iscatter(const void *sendbuf, int sendcount, MPI_Datatype sendtype, void *recvbuf, int recvcount, MPI_Datatype recvtype, int root, MPI_Comm comm, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Iscatter,(sendbuf,sendcount,sendtype,recvbuf,recvcount,recvtype,root,comm,request));
    }
    inline int scatterv(const void *sendbuf, const int sendcounts[], const int displs[], MPI_Datatype sendtype, void *recvbuf, int recvcount, MPI_Datatype recvtype, int root, MPI_Comm comm){
        CALL_LOG_RETURN(MPI_Scatterv,(sendbuf,sendcounts,displs,sendtype,recvbuf,recvcount,recvtype,root,comm));
    }
    inline int iscatterv(const void *sendbuf, const int sendcounts[], const int displs[], MPI_Datatype sendtype, void *recvbuf, int recvcount, MPI_Datatype recvtype, int root, MPI_Comm comm, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Iscatterv,(sendbuf,sendcounts,displs,sendtype,recvbuf,recvcount,recvtype,root,comm,request));
    }
    inline int send_init(const void *buf, int count, MPI_Datatype datatype, int dest, int tag, MPI_Comm comm, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Send_init,(buf,count,datatype,dest,tag,comm,request));
    }
    inline int send(const void *buf, int count, MPI_Datatype datatype, int dest, int tag, MPI_Comm comm){
        CALL_LOG_RETURN(MPI_Send,(buf,count,datatype,dest,tag,comm));
    }
    inline int sendrecv(const void *sendbuf, int sendcount, MPI_Datatype sendtype, int dest, int sendtag, void *recvbuf, int recvcount, MPI_Datatype recvtype, int source, int recvtag, MPI_Comm comm, MPI_Status *status){
        CALL_LOG_RETURN(MPI_Sendrecv,(sendbuf,sendcount,sendtype,dest,sendtag,recvbuf,recvcount,recvtype,source,recvtag,comm,status));
    }
    inline int sendrecv_replace(void * buf, int count, MPI_Datatype datatype, int dest, int sendtag, int source, int recvtag, MPI_Comm comm, MPI_Status *status){
        CALL_LOG_RETURN(MPI_Sendrecv_replace,(buf,count,datatype,dest,sendtag,source,recvtag,comm,status));
    }
    inline int ssend_init(const void *buf, int count, MPI_Datatype datatype, int dest, int tag, MPI_Comm comm, MPI_Request *request){
        CALL_LOG_RETURN(MPI_Ssend_init,(buf,count,datatype,dest,tag,comm,request));
    }
    inline int ssend(const void *buf, int count, MPI_Datatype datatype, int dest, int tag, MPI_Comm comm){
        CALL_LOG_RETURN(MPI_Ssend,(buf,count,datatype,dest,tag,comm));
    }
    inline int start(MPI_Request *request){
        CALL_LOG_RETURN(MPI_Start,(request));
    }
    ...
    inline int testany(int count, MPI_Request array_of_requests[], int *index, int *flag, MPI_Status *status){
    ...
    inline int testsome(int incount, MPI_Request array_of_requests[], int *outcount, int array_of_indices[], MPI_Status array_of_statuses[]){
        CALL_LOG_RETURN(MPI_Testsome,(incount,array_of_requests,outcount,array_of_indices,array_of_statuses));
    }
    inline int topo_test(MPI_Comm comm, int *status){
        CALL_LOG_RETURN(MPI_Topo_test,(comm,status));
    }
    inline MPI_Fint type_c2f(MPI_Datatype datatype){
        CALL_LOG_RETURN(MPI_Type_c2f,(datatype));
    }
    inline int type_commit(MPI_Datatype *type){
        CALL_LOG_RETURN(MPI_Type_commit,(type));
    }
    ...
    inline int type_create_darray(int size, int rank, int ndims, const int gsize_array[], const int distrib_array[], const int darg_array[], const int psize_array[], int order, MPI_Datatype oldtype, MPI_Datatype *newtype){
        CALL_LOG_RETURN(MPI_Type_create_darray,(size,rank,ndims,gsize_array,distrib_array,darg_array,psize_array,order,oldtype,newtype));
    }
    ...
    inline int type_create_hindexed_block(int count, int blocklength, const MPI_Aint array_of_displacements[], MPI_Datatype oldtype, MPI_Datatype *newtype){
        CALL_LOG_RETURN(MPI_Type_create_hindexed_block,(count,blocklength,array_of_displacements,oldtype,newtype));
    }
    inline int type_create_hindexed(int count, const int array_of_blocklengths[], const MPI_Aint array_of_displacements[], MPI_Datatype oldtype, MPI_Datatype *newtype){
        CALL_LOG_RETURN(MPI_Type_create_hindexed,(count,array_of_blocklengths,array_of_displacements,oldtype,newtype));
    }
    ...
    inline int type_create_keyval(MPI_Type_copy_attr_function *type_copy_attr_fn, MPI_Type_delete_attr_function *type_delete_attr_fn, int *type_keyval, void *extra_state){
        CALL_LOG_RETURN(MPI_Type_create_keyval,(type_copy_attr_fn,type_delete_attr_fn,type_keyval,extra_state));
    }
    inline int type_create_indexed_block(int count, int blocklength, const int array_of_displacements[], MPI_Datatype oldtype, MPI_Datatype *newtype){
        CALL_LOG_RETURN(MPI_Type_create_indexed_block,(count,blocklength,array_of_displacements,oldtype,newtype));
    }
    inline int type_create_struct(int count, const int array_of_block_lengths[], const MPI_Aint array_of_displacements[], const MPI_Datatype array_of_types[], MPI_Datatype *newtype){
        CALL_LOG_RETURN(MPI_Type_create_struct,(count,array_of_block_lengths,array_of_displacements,array_of_types,newtype));
    }
    inline int type_create_subarray(int ndims, const int size_array[], const int subsize_array[], const int start_array[], int order, MPI_Datatype oldtype, MPI_Datatype *newtype){
        CALL_LOG_RETURN(MPI_Type_create_subarray,(ndims,size_array,subsize_array,start_array,order,oldtype,newtype));
    }
    ...
    inline int type_free(MPI_Datatype *type){
        CALL_LOG_RETURN(MPI_Type_free,(type));
    }
    inline int type_free_keyval(int *type_keyval){
        CALL_LOG_RETURN(MPI_Type_free_keyval,(type_keyval));
    }
    inline MPI_Datatype type_f2c(MPI_Fint datatype){
        CALL_LOG_RETURN(MPI_Type_f2c,(datatype));
    }
    ...
    inline int type_get_contents(MPI_Datatype mtype, int max_integers, int max_addresses, int max_datatypes, int array_of_integers[], MPI_Aint array_of_addresses[], MPI_Datatype array_of_datatypes[]){
        CALL_LOG_RETURN(MPI_Type_get_contents,(mtype,max_integers,max_addresses,max_datatypes,array_of_integers,array_of_addresses,array_of_datatypes));
    }
    inline int type_get_envelope(MPI_Datatype type, int *num_integers, int *num_addresses, int *num_datatypes, int *combiner){
        CALL_LOG_RETURN(MPI_Type_get_envelope,(type,num_integers,num_addresses,num_datatypes,combiner));
    }
    ...
    inline int type_get_true_extent_x(MPI_Datatype datatype, MPI_Count *true_lb, MPI_Count *true_extent){
        CALL_LOG_RETURN(MPI_Type_get_true_extent_x,(datatype,true_lb,true_extent));
    }
    inline int type_indexed(int count, const int array_of_blocklengths[], const int array_of_displacements[], MPI_Datatype oldtype, MPI_Datatype *newtype){
        CALL_LOG_RETURN(MPI_Type_indexed,(count,array_of_blocklengths,array_of_displacements,oldtype,newtype));
    }
    ...
    inline int unpack(const void *inbuf, int insize, int *position, void *outbuf, int outcount, MPI_Datatype datatype, MPI_Comm comm){
    ...
    inline int unpack_external(const char datarep[], const void *inbuf, MPI_Aint insize, MPI_Aint *position, void *outbuf, int outcount, MPI_Datatype datatype){
        CALL_LOG_RETURN(MPI_Unpack_external,(datarep,inbuf,insize,position,outbuf,outcount,datatype));
    }
    ...
    inline int waitsome(int incount, MPI_Request array_of_requests[], int *outcount, int array_of_indices[], MPI_Status array_of_statuses[]){
        CALL_LOG_RETURN(MPI_Waitsome,(incount,array_of_requests,outcount,array_of_indices,array_of_statuses));
    }
    ...
    inline MPI_Fint win_c2f(MPI_Win win){
        CALL_LOG_RETURN(MPI_Win_c2f,(win));
    }
    ...
    inline int win_complete(MPI_Win win){
        CALL_LOG_RETURN(MPI_Win_complete,(win));
    }
    ...
    inline int win_create_errhandler(MPI_Win_errhandler_function *function, MPI_Errhandler *errhandler){
    ...
    inline int win_create_keyval(MPI_Win_copy_attr_function *win_copy_attr_fn, MPI_Win_delete_attr_function *win_delete_attr_fn, int *win_keyval, void *extra_state){
        CALL_LOG_RETURN(MPI_Win_create_keyval,(win_copy_attr_fn,win_delete_attr_fn,win_keyval,extra_state));
    }
    ...
    inline MPI_Win win_f2c(MPI_Fint win){
        CALL_LOG_RETURN(MPI_Win_f2c,(win));
    }
    inline int win_fence(int assert, MPI_Win win){
        CALL_LOG_RETURN(MPI_Win_fence,(assert,win));
    }
    inline int win_flush(int rank, MPI_Win win){
        CALL_LOG_RETURN(MPI_Win_flush,(rank,win));
    }
    inline int win_flush_all(MPI_Win win){
        CALL_LOG_RETURN(MPI_Win_flush_all,(win));
    }
    ...
    inline int win_flush_local_all(MPI_Win win){
        CALL_LOG_RETURN(MPI_Win_flush_local_all,(win));
    }
    inline int win_free(MPI_Win *win){
        CALL_LOG_RETURN(MPI_Win_free,(win));
    }
    ...
    inline int win_sync(MPI_Win win){
        CALL_LOG_RETURN(MPI_Win_sync,(win));
    }
    inline int win_test(MPI_Win win, int *flag){
        CALL_LOG_RETURN(MPI_Win_test,(win,flag));
    }
    inline int win_unlock(int rank, MPI_Win win){
        CALL_LOG_RETURN(MPI_Win_unlock,(rank,win));
    }
    inline int win_unlock_all(MPI_Win win){
        CALL_LOG_RETURN(MPI_Win_unlock_all,(win));
    }
    inline int win_wait(MPI_Win win){
        CALL_LOG_RETURN(MPI_Win_wait,(win));
    }
    inline double wtick(void){
        CALL_LOG_RETURN(MPI_Wtick,());
    }
    inline double wtime(void){
        CALL_LOG_RETURN(MPI_Wtime,());
    }
