...
namespace shamsys::env {
    ...
    const std::optional<std::string> MV2_COMM_WORLD_LOCAL_RANK = getenv_str("MV2_COMM_WORLD_LOCAL_RANK");
    const std::optional<std::string> OMPI_COMM_WORLD_LOCAL_RANK = getenv_str("OMPI_COMM_WORLD_LOCAL_RANK");
