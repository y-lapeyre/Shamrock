...
TestStart(Unittest, "syclhandler/test_sycl_mpi_types_sizes", test_sycl_mpi_types_sizes, -1){
    ...
    shamtest::asserts().assert_bool("mpi type i16    correct", get_mpi_size( mpi_type_i16   ) == sizeof(i16 ));
    shamtest::asserts().assert_bool("mpi type i8     correct", get_mpi_size( mpi_type_i8    ) == sizeof(i8  ));
    shamtest::asserts().assert_bool("mpi type u64    correct", get_mpi_size( mpi_type_u64   ) == sizeof(u64 ));
    shamtest::asserts().assert_bool("mpi type u32    correct", get_mpi_size( mpi_type_u32   ) == sizeof(u32 ));
    shamtest::asserts().assert_bool("mpi type u16    correct", get_mpi_size( mpi_type_u16   ) == sizeof(u16 ));
    shamtest::asserts().assert_bool("mpi type u8     correct", get_mpi_size( mpi_type_u8    ) == sizeof(u8  ));
    shamtest::asserts().assert_bool("mpi type f16    correct", get_mpi_size( mpi_type_f16   ) == sizeof(f16 ));
    shamtest::asserts().assert_bool("mpi type f32    correct", get_mpi_size( mpi_type_f32   ) == sizeof(f32 ));
    shamtest::asserts().assert_bool("mpi type f64    correct", get_mpi_size( mpi_type_f64   ) == sizeof(f64 ));
    shamtest::asserts().assert_bool("mpi type i64_2  correct", get_mpi_size( mpi_type_i64_2 ) == sizeof(i64_2 ));
    shamtest::asserts().assert_bool("mpi type i32_2  correct", get_mpi_size( mpi_type_i32_2 ) == sizeof(i32_2 ));
    shamtest::asserts().assert_bool("mpi type i16_2  correct", get_mpi_size( mpi_type_i16_2 ) == sizeof(i16_2 ));
    shamtest::asserts().assert_bool("mpi type i8_2   correct", get_mpi_size( mpi_type_i8_2  ) == sizeof(i8_2  ));
    shamtest::asserts().assert_bool("mpi type u64_2  correct", get_mpi_size( mpi_type_u64_2 ) == sizeof(u64_2 ));
    shamtest::asserts().assert_bool("mpi type u32_2  correct", get_mpi_size( mpi_type_u32_2 ) == sizeof(u32_2 ));
    shamtest::asserts().assert_bool("mpi type u16_2  correct", get_mpi_size( mpi_type_u16_2 ) == sizeof(u16_2 ));
    shamtest::asserts().assert_bool("mpi type u8_2   correct", get_mpi_size( mpi_type_u8_2  ) == sizeof(u8_2  ));
    shamtest::asserts().assert_bool("mpi type f16_2  correct", get_mpi_size( mpi_type_f16_2 ) == sizeof(f16_2 ));
    shamtest::asserts().assert_bool("mpi type f32_2  correct", get_mpi_size( mpi_type_f32_2 ) == sizeof(f32_2 ));
    shamtest::asserts().assert_bool("mpi type f64_2  correct", get_mpi_size( mpi_type_f64_2 ) == sizeof(f64_2 ));
    shamtest::asserts().assert_bool("mpi type i64_3  correct", get_mpi_size( mpi_type_i64_3 ) == sizeof(i64_3 ));
    shamtest::asserts().assert_bool("mpi type i32_3  correct", get_mpi_size( mpi_type_i32_3 ) == sizeof(i32_3 ));
    shamtest::asserts().assert_bool("mpi type i16_3  correct", get_mpi_size( mpi_type_i16_3 ) == sizeof(i16_3 ));
    shamtest::asserts().assert_bool("mpi type i8_3   correct", get_mpi_size( mpi_type_i8_3  ) == sizeof(i8_3  ));
    shamtest::asserts().assert_bool("mpi type u64_3  correct", get_mpi_size( mpi_type_u64_3 ) == sizeof(u64_3 ));
    shamtest::asserts().assert_bool("mpi type u32_3  correct", get_mpi_size( mpi_type_u32_3 ) == sizeof(u32_3 ));
    shamtest::asserts().assert_bool("mpi type u16_3  correct", get_mpi_size( mpi_type_u16_3 ) == sizeof(u16_3 ));
    shamtest::asserts().assert_bool("mpi type u8_3   correct", get_mpi_size( mpi_type_u8_3  ) == sizeof(u8_3  ));
    shamtest::asserts().assert_bool("mpi type f16_3  correct", get_mpi_size( mpi_type_f16_3 ) == sizeof(f16_3 ));
    shamtest::asserts().assert_bool("mpi type f32_3  correct", get_mpi_size( mpi_type_f32_3 ) == sizeof(f32_3 ));
    shamtest::asserts().assert_bool("mpi type f64_3  correct", get_mpi_size( mpi_type_f64_3 ) == sizeof(f64_3 ));
    shamtest::asserts().assert_bool("mpi type i64_4  correct", get_mpi_size( mpi_type_i64_4 ) == sizeof(i64_4 ));
    shamtest::asserts().assert_bool("mpi type i32_4  correct", get_mpi_size( mpi_type_i32_4 ) == sizeof(i32_4 ));
    shamtest::asserts().assert_bool("mpi type i16_4  correct", get_mpi_size( mpi_type_i16_4 ) == sizeof(i16_4 ));
    shamtest::asserts().assert_bool("mpi type i8_4   correct", get_mpi_size( mpi_type_i8_4  ) == sizeof(i8_4  ));
    shamtest::asserts().assert_bool("mpi type u64_4  correct", get_mpi_size( mpi_type_u64_4 ) == sizeof(u64_4 ));
    shamtest::asserts().assert_bool("mpi type u32_4  correct", get_mpi_size( mpi_type_u32_4 ) == sizeof(u32_4 ));
    shamtest::asserts().assert_bool("mpi type u16_4  correct", get_mpi_size( mpi_type_u16_4 ) == sizeof(u16_4 ));
    shamtest::asserts().assert_bool("mpi type u8_4   correct", get_mpi_size( mpi_type_u8_4  ) == sizeof(u8_4  ));
    shamtest::asserts().assert_bool("mpi type f16_4  correct", get_mpi_size( mpi_type_f16_4 ) == sizeof(f16_4 ));
    shamtest::asserts().assert_bool("mpi type f32_4  correct", get_mpi_size( mpi_type_f32_4 ) == sizeof(f32_4 ));
    shamtest::asserts().assert_bool("mpi type f64_4  correct", get_mpi_size( mpi_type_f64_4 ) == sizeof(f64_4 ));
    shamtest::asserts().assert_bool("mpi type i64_8  correct", get_mpi_size( mpi_type_i64_8 ) == sizeof(i64_8 ));
    shamtest::asserts().assert_bool("mpi type i32_8  correct", get_mpi_size( mpi_type_i32_8 ) == sizeof(i32_8 ));
    shamtest::asserts().assert_bool("mpi type i16_8  correct", get_mpi_size( mpi_type_i16_8 ) == sizeof(i16_8 ));
    shamtest::asserts().assert_bool("mpi type i8_8   correct", get_mpi_size( mpi_type_i8_8  ) == sizeof(i8_8  ));
    shamtest::asserts().assert_bool("mpi type u64_8  correct", get_mpi_size( mpi_type_u64_8 ) == sizeof(u64_8 ));
    shamtest::asserts().assert_bool("mpi type u32_8  correct", get_mpi_size( mpi_type_u32_8 ) == sizeof(u32_8 ));
    shamtest::asserts().assert_bool("mpi type u16_8  correct", get_mpi_size( mpi_type_u16_8 ) == sizeof(u16_8 ));
    shamtest::asserts().assert_bool("mpi type u8_8   correct", get_mpi_size( mpi_type_u8_8  ) == sizeof(u8_8  ));
    shamtest::asserts().assert_bool("mpi type f16_8  correct", get_mpi_size( mpi_type_f16_8 ) == sizeof(f16_8 ));
    shamtest::asserts().assert_bool("mpi type f32_8  correct", get_mpi_size( mpi_type_f32_8 ) == sizeof(f32_8 ));
    shamtest::asserts().assert_bool("mpi type f64_8  correct", get_mpi_size( mpi_type_f64_8 ) == sizeof(f64_8 ));
    shamtest::asserts().assert_bool("mpi type i64_16 correct", get_mpi_size( mpi_type_i64_16) == sizeof(i64_16));
    shamtest::asserts().assert_bool("mpi type i32_16 correct", get_mpi_size( mpi_type_i32_16) == sizeof(i32_16));
    shamtest::asserts().assert_bool("mpi type i16_16 correct", get_mpi_size( mpi_type_i16_16) == sizeof(i16_16));
    shamtest::asserts().assert_bool("mpi type i8_16  correct", get_mpi_size( mpi_type_i8_16 ) == sizeof(i8_16 ));
    shamtest::asserts().assert_bool("mpi type u64_16 correct", get_mpi_size( mpi_type_u64_16) == sizeof(u64_16));
    shamtest::asserts().assert_bool("mpi type u32_16 correct", get_mpi_size( mpi_type_u32_16) == sizeof(u32_16));
    shamtest::asserts().assert_bool("mpi type u16_16 correct", get_mpi_size( mpi_type_u16_16) == sizeof(u16_16));
    shamtest::asserts().assert_bool("mpi type u8_16  correct", get_mpi_size( mpi_type_u8_16 ) == sizeof(u8_16 ));
