...
namespace syclalgs::reduction::impl {
    ...
    template<class T, class Op, u32 work_group_size> inline T reduce_manual(sycl::queue & q, sycl::buffer<T> & buf1, u32 start_id, u32 end_id){
    ...
    template<class T, class Op> inline T reduce_sycl_2020(sycl::queue & q, sycl::buffer<T> & buf1, u32 start_id, u32 end_id){
