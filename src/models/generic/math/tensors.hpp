...
template <class T> struct SymTensor3d_1 {
    ...
    static constexpr u32 compo_offset  = 1;
    static constexpr u32 compo_cnt_sum = SymTensor3d_1::compo_cnt + 1;
...
template <class T> struct SymTensor3d_2 {
    ...
    static constexpr u32 compo_offset  = SymTensor3d_1<T>::compo_cnt_sum;
    static constexpr u32 compo_cnt_sum = SymTensor3d_1<T>::compo_cnt_sum + compo_cnt;
...
template <class T> struct SymTensor3d_3 {
    ...
    static constexpr u32 compo_offset  = SymTensor3d_2<T>::compo_cnt_sum;
    static constexpr u32 compo_cnt_sum = SymTensor3d_2<T>::compo_cnt_sum + compo_cnt;
...
template <class T> struct SymTensor3d_4 {
    ...
    static constexpr u32 compo_offset  = SymTensor3d_3<T>::compo_cnt_sum;
    static constexpr u32 compo_cnt_sum = SymTensor3d_3<T>::compo_cnt_sum + compo_cnt;
...
template <class T> struct SymTensor3d_5 {
    ...
    static constexpr u32 compo_offset  = SymTensor3d_4<T>::compo_cnt_sum;
    static constexpr u32 compo_cnt_sum = SymTensor3d_4<T>::compo_cnt_sum + compo_cnt;
...
template <class T, u32 low_order, u32 high_order> struct TensorCollection;

template<class T> struct TensorCollection<T,0, 5> {
    T t0;
    SymTensor3d_1<T> t1;
    SymTensor3d_2<T> t2;
    SymTensor3d_3<T> t3;
    ...
    static constexpr u32 num_component = SymTensor3d_5<T>::compo_cnt_sum;

    inline static TensorCollection from_vec(const sycl::vec<T, 3> &v) {
        auto A1 = SymTensor3d_1<T>{v.x(), v.y(), v.z()};

        auto A2 = SymTensor3d_2<T>{
            A1.v_0 * A1.v_0, A1.v_1 * A1.v_0, A1.v_2 * A1.v_0, A1.v_1 * A1.v_1, A1.v_2 * A1.v_1, A1.v_2 * A1.v_2,
        };

        auto A3 =
            SymTensor3d_3<T>{A2.v_00 * A1.v_0, A2.v_01 * A1.v_0, A2.v_02 * A1.v_0, A2.v_11 * A1.v_0, A2.v_12 * A1.v_0,
                            A2.v_22 * A1.v_0, A2.v_11 * A1.v_1, A2.v_12 * A1.v_1, A2.v_22 * A1.v_1, A2.v_22 * A1.v_2};

        auto A4 =
            SymTensor3d_4<T>{A3.v_000 * A1.v_0, A3.v_001 * A1.v_0, A3.v_002 * A1.v_0, A3.v_011 * A1.v_0, A3.v_012 * A1.v_0,
                            A3.v_022 * A1.v_0, A3.v_111 * A1.v_0, A3.v_112 * A1.v_0, A3.v_122 * A1.v_0, A3.v_222 * A1.v_0,
                            A3.v_111 * A1.v_1, A3.v_112 * A1.v_1, A3.v_122 * A1.v_1, A3.v_222 * A1.v_1, A3.v_222 * A1.v_2};

        auto A5 = SymTensor3d_5<T>{A4.v_0000 * A1.v_0, A4.v_0001 * A1.v_0, A4.v_0002 * A1.v_0, A4.v_0011 * A1.v_0,
                                A4.v_0012 * A1.v_0, A4.v_0022 * A1.v_0, A4.v_0111 * A1.v_0, A4.v_0112 * A1.v_0,
                                A4.v_0122 * A1.v_0, A4.v_0222 * A1.v_0, A4.v_1111 * A1.v_0, A4.v_1112 * A1.v_0,
                                A4.v_1122 * A1.v_0, A4.v_1222 * A1.v_0, A4.v_2222 * A1.v_0, A4.v_1111 * A1.v_1,
                                A4.v_1112 * A1.v_1, A4.v_1122 * A1.v_1, A4.v_1222 * A1.v_1, A4.v_2222 * A1.v_1,
                                A4.v_2222 * A1.v_2};
    ...
    template <class Tacc> inline void store(Tacc &acc, u32 offset) {
        ...
        t2.store(acc, offset + SymTensor3d_2<T>::compo_offset);
        t3.store(acc, offset + SymTensor3d_3<T>::compo_offset);
        t4.store(acc, offset + SymTensor3d_4<T>::compo_offset);
        t5.store(acc, offset + SymTensor3d_5<T>::compo_offset);
    }

    template <class Tacc> inline static TensorCollection load(Tacc &acc, u32 offset) {
        return TensorCollection{
            acc[offset + 0],
            SymTensor3d_1<T>::load(acc, offset + SymTensor3d_1<T>::compo_offset),
            SymTensor3d_2<T>::load(acc, offset + SymTensor3d_2<T>::compo_offset),
            SymTensor3d_3<T>::load(acc, offset + SymTensor3d_3<T>::compo_offset),
            SymTensor3d_4<T>::load(acc, offset + SymTensor3d_4<T>::compo_offset),
            SymTensor3d_5<T>::load(acc, offset + SymTensor3d_5<T>::compo_offset)};
    }
};


template <class T> struct TensorCollection<T,0, 4> {
    T t0;
    SymTensor3d_1<T> t1;
    SymTensor3d_2<T> t2;
    SymTensor3d_3<T> t3;
    ...
    static constexpr u32 num_component = SymTensor3d_4<T>::compo_cnt_sum;
    ...
    template <class Tacc> inline static TensorCollection load(Tacc &acc, u32 offset) {
        return TensorCollection{
            acc[offset + 0], SymTensor3d_1<T>::load(acc, offset + SymTensor3d_1<T>::compo_offset),
            SymTensor3d_2<T>::load(acc, offset + SymTensor3d_2<T>::compo_offset),
            SymTensor3d_3<T>::load(acc, offset + SymTensor3d_3<T>::compo_offset),
            SymTensor3d_4<T>::load(acc, offset + SymTensor3d_4<T>::compo_offset)};
    }
...
template <class T> struct TensorCollection<T,0, 3> {
    T t0;
    SymTensor3d_1<T> t1;
    SymTensor3d_2<T> t2;
    SymTensor3d_3<T> t3;

    static constexpr u32 num_component = SymTensor3d_3<T>::compo_cnt_sum;
...
template <class T> struct TensorCollection<T,0, 2> {
    T t0;
    SymTensor3d_1<T> t1;
    SymTensor3d_2<T> t2;

    static constexpr u32 num_component = SymTensor3d_2<T>::compo_cnt_sum;
...
template <class T> struct TensorCollection<T,0, 1> {
    T t0;
    SymTensor3d_1<T> t1;

    static constexpr u32 num_component = SymTensor3d_1<T>::compo_cnt_sum;
    ...
    template <class Tacc> inline static TensorCollection load(Tacc &acc, u32 offset) {
        return TensorCollection{acc[offset + 0], SymTensor3d_1<T>::load(acc, offset + SymTensor3d_1<T>::compo_offset)};
    }
};

template <class T> struct TensorCollection<T,0, 0> {
    T t0;
    ...
    template <class Tacc> inline static TensorCollection load(Tacc &acc, u32 offset) {
        return TensorCollection{acc[offset + 0]};
    }
};
