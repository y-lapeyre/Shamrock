...
//B32 sort kernel is less performant than the B16 because of cache size
            ...
            if (inc >= 16 && ninc == 0){
                ...
                auto ker_sort_morton_b32 = [&](sycl::handler &cgh) {
                    ...
                    cgh.parallel_for<Bitonic_sort_B32_morton64>(
            ...
            if (inc >= 8 && ninc == 0){
                ...
                auto ker_sort_morton_b16 = [&](sycl::handler &cgh) {
                    ...
                    cgh.parallel_for<Bitonic_sort_B16_morton32>(
                        range, [=](sycl::item<1> item) {
                            //(__global data_t * data,__global uint * ids,int inc,int dir)
            ...
            if (inc >= 4 && ninc == 0){
                ...
                auto ker_sort_morton_b8 = [&](sycl::handler &cgh) {
                    ...
                    cgh.parallel_for<Bitonic_sort_B8_morton32>(
                        range, [=](sycl::item<1> item) {
                            //(__global data_t * data,__global uint * ids,int inc,int dir)
            ...
            if (inc >= 2 && ninc == 0){
                ...
                auto ker_sort_morton_b4 = [&](sycl::handler &cgh) {
                    ...
                    auto m =  buf_morton->get_access<sycl::access::mode::read_write>(cgh);
                    auto id = buf_index->get_access<sycl::access::mode::read_write>(cgh);
                    cgh.parallel_for<Bitonic_sort_B4_morton32>(
                        range, [=](sycl::item<1> item) {
                            //(__global data_t * data,__global uint * ids,int inc,int dir)
            ...
            if (ninc == 0){
                ...
                auto ker_sort_morton_b2 = [&](sycl::handler &cgh) {
                    ...
                    cgh.parallel_for<Bitonic_sort_B2_morton32>(
                        range, [=](sycl::item<1> item) {
                            //(__global data_t * data,__global uint * ids,int inc,int dir)
...
//B32 sort kernel is less performant than the B16 because of cache size
            ...
            if (inc >= 8 && ninc == 0){
                ...
                auto ker_sort_morton_b16 = [&](sycl::handler &cgh) {
                    ...
                    cgh.parallel_for<Bitonic_sort_B16_morton64>(
                        range, [=](sycl::item<1> item) {
                            //(__global data_t * data,__global uint * ids,int inc,int dir)
            ...
            if (inc >= 4 && ninc == 0){
                ...
                auto ker_sort_morton_b8 = [&](sycl::handler &cgh) {
                    ...
                    cgh.parallel_for<Bitonic_sort_B8_morton64>(
                        range, [=](sycl::item<1> item) {
                            //(__global data_t * data,__global uint * ids,int inc,int dir)
            ...
            if (inc >= 2 && ninc == 0){
                ...
                auto ker_sort_morton_b4 = [&](sycl::handler &cgh) {
                    ...
                    auto m =  buf_morton->get_access<sycl::access::mode::read_write>(cgh);
                    auto id = buf_index->get_access<sycl::access::mode::read_write>(cgh);
                    cgh.parallel_for<Bitonic_sort_B4_morton64>(
                        range, [=](sycl::item<1> item) {
                            //(__global data_t * data,__global uint * ids,int inc,int dir)
            ...
            if (ninc == 0){
                ...
                auto ker_sort_morton_b2 = [&](sycl::handler &cgh) {
                    ...
                    cgh.parallel_for<Bitonic_sort_B2_morton64>(
                        range, [=](sycl::item<1> item) {
                            //(__global data_t * data,__global uint * ids,int inc,int dir)
