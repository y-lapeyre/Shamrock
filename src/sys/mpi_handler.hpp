...
namespace mpi{
    ...
    */
    ...
    void abort(MPI_Comm comm, int errorcode);
    ...
    void type_create_struct(int count, const int array_of_block_lengths[],         const MPI_Aint array_of_displacements[],         const MPI_Datatype array_of_types[],         MPI_Datatype *newtype);
