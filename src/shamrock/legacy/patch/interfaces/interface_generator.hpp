    ...
    inline static sycl::buffer<InterfaceComInternal, 2> get_interface_list_v1(PatchScheduler &sched, SerialPatchTree<vectype> &sptree,
...

        {
            ...
            for (u64 i = 0; i < local_pcount; i++) {
                ...
                lbox_max[i] = (vectype{sched.patch_list.local[i].coord_max[0], sched.patch_list.local[i].coord_max[1],
            ...
            for (u64 i = 0; i < global_pcount; i++) {
                ...
                gbox_max[i] = (vectype{sched.patch_list.global[i].coord_max[0], sched.patch_list.global[i].coord_max[1],
