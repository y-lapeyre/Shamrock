...
Register_pymod(sfclibinit){
    ...
    sfc_module.def("icoord_to_morton_3d_u64",[](u32 x, u32 y, u32 z) -> u64 {
    ...
    sfc_module.def("icoord_to_morton_3d_u32",[](u16 x, u16 y, u16 z) -> u32 {
        return MortonCodes<u32, 3>::icoord_to_morton(x, y, z);
    }, R"pbdoc(
        Convert a 3d integer coord to morton code
    )pbdoc");

    sfc_module.def("morton_to_icoord_3d_u32",[](u32 m) -> std::array<u16,3> {
    ...
    sfc_module.def("to_morton_grid_3d_u32_f32_3", [](std::array<f32,3> pos, std::array<f32,3> bmin,std::array<f32,3> bmax) -> std::array<u16,3> {
    ...
    sfc_module.def("to_morton_grid_3d_u32_f64_3", [](std::array<f64,3> pos, std::array<f64,3> bmin,std::array<f64,3> bmax) -> std::array<u16,3> {
    ...
    sfc_module.def("to_morton_grid_3d_u64_f32_3", [](std::array<f32,3> pos, std::array<f32,3> bmin,std::array<f32,3> bmax) -> std::array<u32,3> {
        f32_3 pos_ {pos[0],pos[1],pos[2]};
        f32_3 bmin_ {bmin[0],bmin[1],bmin[2]};
        f32_3 bmax_ {bmax[0],bmax[1],bmax[2]};
    ...
    sfc_module.def("to_morton_grid_3d_u64_f64_3", [](std::array<f64,3> pos, std::array<f64,3> bmin,std::array<f64,3> bmax) -> std::array<u32,3> {
        f64_3 pos_ {pos[0],pos[1],pos[2]};
        f64_3 bmin_ {bmin[0],bmin[1],bmin[2]};
        f64_3 bmax_ {bmax[0],bmax[1],bmax[2]};
