...
namespace shamrock::sfc::bmi {
    ...
    template<>
    inline 64 expand_bits<64,1>(64 x){
    ...
    inline u64 contract_bits<u64,1>(u64 src) {
        src = (src | (src >> 1U))  & 0x3333333333333333Ull;
        src = (src | (src >> 2U))  & 0x0f0f0f0f0f0f0f0fUll;
        src = (src | (src >> 4U))  & 0x00ff00ff00ff00ffUll;
        src = (src | (src >> 8U))  & 0x0000ffff0000ffffUll;
        src = (src | (src >> 16U)) & 0x00000000ffffffffUll;
        return src;
    }
