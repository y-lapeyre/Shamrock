...
template<class T> struct SymTensorCollection<T,0, 5> {
    T t0;
    SymTensor3d_1<T> t1;
    SymTensor3d_2<T> t2;
    SymTensor3d_3<T> t3;
    ...
    static constexpr u32 num_component = 1 + 
        SymTensor3d_1<T>::compo_cnt + 
        SymTensor3d_2<T>::compo_cnt + 
        SymTensor3d_3<T>::compo_cnt + 
        SymTensor3d_4<T>::compo_cnt + 
    ...
    template <class Tacc> inline static SymTensorCollection load(Tacc &acc, u32 offset) {
...
template <class T> struct SymTensorCollection<T,0, 4> {
    T t0;
    SymTensor3d_1<T> t1;
    SymTensor3d_2<T> t2;
    SymTensor3d_3<T> t3;
...
template <class T> struct SymTensorCollection<T,0, 3> {
    T t0;
    SymTensor3d_1<T> t1;
    SymTensor3d_2<T> t2;
    SymTensor3d_3<T> t3;
...
template <class T> struct SymTensorCollection<T,0, 2> {
    T t0;
    SymTensor3d_1<T> t1;
    SymTensor3d_2<T> t2;
...
template <class T> struct SymTensorCollection<T,0, 1> {
    T t0;
    SymTensor3d_1<T> t1;
...
template <class T> struct SymTensorCollection<T,0, 0> {
    T t0;
...
template<class T> struct SymTensorCollection<T,1, 5> {
...
template <class T> struct SymTensorCollection<T,1, 4> {
...
template <class T> struct SymTensorCollection<T,1, 3> {
...
template <class T> struct SymTensorCollection<T,1, 2> {
...
template <class T> struct SymTensorCollection<T,1, 1> {
