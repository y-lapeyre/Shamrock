...
std::vector<std::string> PatchDataLayout::get_field_names(){
    ...
    void to_json(nlohmann::json &j, const PatchDataLayout &p){
        ...
        p.for_each_field_any([&](auto & field){
            ...
            auto get_tname = [](){
                if (std::is_same<base_t, f32   >::value){return "f32";}
                else if (std::is_same<base_t, f32_2 >::value){return "f32_2";}
                else if (std::is_same<base_t, f32_3 >::value){return "f32_3";}
                else if (std::is_same<base_t, f32_4 >::value){return "f32_4";}
                else if (std::is_same<base_t, f32_8 >::value){return "f32_8";}
                else if (std::is_same<base_t, f32_16>::value){return "f32_16";}
                else if (std::is_same<base_t, f64   >::value){return "f64";}
                else if (std::is_same<base_t, f64_2 >::value){return "f64_2";}
                else if (std::is_same<base_t, f64_3 >::value){return "f64_3";}
                else if (std::is_same<base_t, f64_4 >::value){return "f64_4";}
                else if (std::is_same<base_t, f64_8 >::value){return "f64_8";}
                else if (std::is_same<base_t, f64_16>::value){return "f64_16";}
                else if (std::is_same<base_t, u32   >::value){return "u32";}
                else if (std::is_same<base_t, u64   >::value){return "u64";}
                else if (std::is_same<base_t, u32_3 >::value){return "u32_3";}
                else if (std::is_same<base_t, u64_3 >::value){return "u64_3";}
                else {
