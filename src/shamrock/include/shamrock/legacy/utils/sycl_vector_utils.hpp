...
inline void print_vec(std::ostream &ostream, sycl::vec<T, 16> a) {
    ostream << "(" << a.s0() << "," << a.s1() << "," << a.s2() << "," << a.s3() << a.s4() << ","
            << a.s5() << "," << a.s6() << "," << a.s7() << a.s8() << "," << a.s9() << "," << a.sA()
            << "," << a.sB() << a.sC() << "," << a.sD() << "," << a.sE() << "," << a.sF() << ")";
}
...
template<>
inline sycl::vec<f32, 2> next_obj(std::mt19937 &eng, std::uniform_real_distribution<f64> &distval) {
    return sycl::vec<f32, 2>{next_obj<f32>(eng, distval), next_obj<f32>(eng, distval)};
}
template<>
inline sycl::vec<f32, 3> next_obj(std::mt19937 &eng, std::uniform_real_distribution<f64> &distval) {
    return sycl::vec<f32, 3>{
        next_obj<f32>(eng, distval), next_obj<f32>(eng, distval), next_obj<f32>(eng, distval)};
}
template<>
inline sycl::vec<f32, 4> next_obj(std::mt19937 &eng, std::uniform_real_distribution<f64> &distval) {
...
template<>
inline sycl::vec<f32, 8> next_obj(std::mt19937 &eng, std::uniform_real_distribution<f64> &distval) {
...
template<>
inline sycl::vec<f64, 2> next_obj(std::mt19937 &eng, std::uniform_real_distribution<f64> &distval) {
    return sycl::vec<f64, 2>{next_obj<f64>(eng, distval), next_obj<f64>(eng, distval)};
}
template<>
inline sycl::vec<f64, 3> next_obj(std::mt19937 &eng, std::uniform_real_distribution<f64> &distval) {
    return sycl::vec<f64, 3>{
        next_obj<f64>(eng, distval), next_obj<f64>(eng, distval), next_obj<f64>(eng, distval)};
}
template<>
inline sycl::vec<f64, 4> next_obj(std::mt19937 &eng, std::uniform_real_distribution<f64> &distval) {
...
template<>
inline sycl::vec<f64, 8> next_obj(std::mt19937 &eng, std::uniform_real_distribution<f64> &distval) {
...
template<>
inline sycl::vec<u16, 3> next_obj(std::mt19937 &eng, std::uniform_real_distribution<f64> &distval) {
    return sycl::vec<u16, 3>{
        next_obj<u16>(eng, distval), next_obj<u16>(eng, distval), next_obj<u16>(eng, distval)};
}

template<>
inline sycl::vec<u32, 3> next_obj(std::mt19937 &eng, std::uniform_real_distribution<f64> &distval) {
