...
namespace shamalgs::random {
    ...
    #define X2(_arg_) \
    template<>\
    sycl::vec<_arg_, 2> mock_value(std::mt19937 & eng, sycl::vec<_arg_, 2> min_bound, sycl::vec<_arg_, 2> max_bound){\
        return {mock_value(eng,min_bound.x(),max_bound.x()),mock_value(eng,min_bound.y(),max_bound.y())};\
    }

    #define X3(_arg_) \
    template<>\
    sycl::vec<_arg_, 3> mock_value(std::mt19937 & eng, sycl::vec<_arg_, 3> min_bound, sycl::vec<_arg_, 3> max_bound){\
        return {\
    ...
    #define X4(_arg_) \
    template<>\
    sycl::vec<_arg_, 4> mock_value(std::mt19937 & eng, sycl::vec<_arg_, 4> min_bound, sycl::vec<_arg_, 4> max_bound){\
        return {\
            mock_value(eng,min_bound.x(),max_bound.x()),\
            mock_value(eng,min_bound.y(),max_bound.y()),\
            mock_value(eng,min_bound.z(),max_bound.z()),\
    ...
    #define X8(_arg_) \
    template<>\
    sycl::vec<_arg_, 8> mock_value(std::mt19937 & eng, sycl::vec<_arg_, 8> min_bound, sycl::vec<_arg_, 8> max_bound){\
        return {\
    ...
    #define X16(_arg_) \
    template<>\
    sycl::vec<_arg_, 16> mock_value(std::mt19937 & eng, sycl::vec<_arg_, 16> min_bound, sycl::vec<_arg_, 16> max_bound){\
        return {\
            mock_value(eng,min_bound.s0(),max_bound.s0()),\
            mock_value(eng,min_bound.s1(),max_bound.s1()),\
            mock_value(eng,min_bound.s2(),max_bound.s2()),\
