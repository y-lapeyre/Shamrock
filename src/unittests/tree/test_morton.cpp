...
#include "tree/kernels/morton_kernels.hpp"
#include <memory>
#include <vector>
...
Test_start("tree::kernels::",morton_kernels,1){
...

    {
        ...
        sycl_xyz_to_morton<u32,f32_3>(SyCLHandler::get_instance().get_queue_compute(0), 2, buf_xyz, f32_3{0,0,0}, f32_3{1,1,1}, buf_morton);
...

    {
        ...
        sycl_xyz_to_morton<u64,f64_3>(SyCLHandler::get_instance().get_queue_compute(0), 2, buf_xyz, f64_3{0,0,0}, f64_3{1,1,1}, buf_morton);
