...
if(DOXYGEN_FOUND)
    ...
    add_custom_target(
        ...
        COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_SOURCE_DIR}/doc/doxygen/html
    ...
    add_custom_target(
        ...
        COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_SOURCE_DIR}/doc/mkdocs/site
                ${CMAKE_BINARY_DIR}/doc/mkdocs
    ...
    add_custom_target(
        ...
        COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_SOURCE_DIR}/doc/sphinx/build
    ...
    add_custom_target(
        ...
        COMMAND ${CMAKE_COMMAND} -E copy ${CMAKE_SOURCE_DIR}/doc/tmpindex.html
                ${CMAKE_BINARY_DIR}/doc/tmpindex.html
        WORKING_DIRECTORY ${CMAKE_BINARY_DIR}
    ...
    add_custom_target(
        shamrock_doc DEPENDS shamrock_doc_tmpindex
